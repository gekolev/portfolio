<template>
	<div class="holder-36days">
		<h1 class="context p-5 md:p-10">Letter explorations. Letter C.</h1>
		<div
			class="content"
			ref="main">
			...
			<svg
				...
				<g>
					...
					<g class="st0">
						...
						<g>
							<path
								d="M822.4,134.1L838.3,371h-15.9c-21.2-70.9-51.6-122-91-153.2c-39.4-31.2-86.7-46.8-141.9-46.8
				...
				c8.9-9.3,15.2-22.1,19-38.5H822.4z" />
						...
						<g>
							...
							<path
								class="st4"
								d="M772.2,222.9c0,0,11.1,21.9,38.4,19.2" />

							<ellipse
								transform="matrix(0.4138 -0.9104 0.9104 0.4138 284.0974 855.329)"
								class="st1"
								cx="806.2"
								cy="207.1"
								rx="3.9"
						...
						<g>
							...
							<path
								class="st6"
								d="M827.1,368.9c0,0-24-232.9-279.1-208S234.1,508.5,290.1,631.2s222.3,305.9,412.5,188.5
