    ...
    <div class="content"  ref="main">
      <svg viewBox="0 0 1080 1080" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g clip-path="url(#clip0_1_2)">
          ...
          <path class="first" d="M272.56 901.392L172 941.512L468.955 131L557.232 150.25L867 941.512L769.624 956L522.659 259.226L511.64 252.779L272.56 901.392Z" fill="black" />
          <path class="second" d="M250.145 617.901L219 696L766.255 593.355L942 426L250.145 617.901Z" fill="black" />
